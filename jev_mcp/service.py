"""Upstream API client for MewCP Jev MCP Server."""
...
from .config import JEV_API_BASE, CONNECT_TIMEOUT, READ_TIMEOUT

logger = logging.getLogger("jev-mcp.service")
